...
const Hello = () => {
  ...
  return (
    <div className="text-[#84A4B5] h-full flex ">
      <div className="h-full w-1/2 flex flex-col justify-center pl-20 ">
        <div className="h-36 ">
          <h3 className="text-lg text-[#E4E6E7]">Hello world. I'm</h3>
          <h1 className="text-[60px] text-[#E4E6E7] ">Ayaz Irshad</h1>
      ...
      <div className="h-full w-1/2 flex justify-center items-center">2</div>
    </div>
  );
};
